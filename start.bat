...
start "Flask 后端 - 端口 5001" cmd /k "cd /d %~dp0 && title Flask 后端 - 端口 5001 && color 0A && .env\Scripts\python.exe backend/app.py"
...
start "爬虫 Workers" cmd /k "cd /d %~dp0 && title 爬虫 Workers && color 0E && .env\Scripts\python.exe -m crawler.workers.run_workers"
